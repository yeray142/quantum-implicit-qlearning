...
NUM_STEPS       = 100_000
LOG_INTERVAL    = 500
WANDB_PROJECT   = "quantum-iql-ablation-measurement"
...
RESULTS_DIR = Path("results/ablation_measurement")
...
def main() -> None:
    ...
    print(f"\n{'='*65}")
    print(f"  [QUANTUM_IQL_ABLATION_MEASUREMENT]  Quantum-IQL Circuit Ablation — Topology / Measurement / Datasize")
    print(f"  Hardware : {hw}")
