...
L ≤ floor(log2(n_qubits)):
  ...
  (2,1)  (4,1)  (4,2)★  (8,1)  (8,2)  [(8,3) excluded]
...
NUM_STEPS       = 100_000
LOG_INTERVAL    = 500
WANDB_PROJECT   = "quantum-iql-qubit-layer-fast"
...
def main() -> None:
    ...
    print(f"\n{'='*65}")
    print(f"  [QUANTUM_IQL_QUBIT_LAYER_FAST]  Quantum-IQL Circuit Ablation — Qubit × Layer Grid")
    print(f"  Hardware : {hw}")
